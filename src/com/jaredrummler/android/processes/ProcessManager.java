...
public class ProcessManager {
  ...
  /**
   * Get a list of user apps running in the foreground for android 5.+.
   *
  ...
  public static List<ActivityManager.RunningAppProcessInfo> getRunningAppProcessInfo(Context ctx) {
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      List<ActivityManager.RunningAppProcessInfo> appProcessInfos = new ArrayList<RunningAppProcessInfo>();
